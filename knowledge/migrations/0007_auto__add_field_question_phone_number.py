...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.phone_number'
        db.add_column('knowledge_question', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.phone_number'
        db.delete_column('knowledge_question', 'phone_number')
    ...
    models = {
        ...
        'knowledge.question': {
            ...
            'categories': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['knowledge.Category']", 'null': 'True', 'blank': 'True'}),
