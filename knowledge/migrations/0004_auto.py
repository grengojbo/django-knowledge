...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field user on 'Category'
        db.create_table('knowledge_category_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['knowledge.category'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('knowledge_category_user', ['category_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field user on 'Category'
        db.delete_table('knowledge_category_user')
    ...
    models = {
        ...
        'knowledge.question': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['knowledge.Category']", 'null': 'True', 'blank': 'True'}),
